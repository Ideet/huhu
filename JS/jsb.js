...
// 1. 动态创建并注入样式（无需 HTML 样式标签）
    ...
    window.parent.hwbr.app = window.parent.hwbr.app || {};
    window.parent.hwbr.app.getPluginList = getPluginList;
    setTimeout(() => {
    ...
    window.parent.hwbr.account = window.parent.hwbr.account || {};
    window.parent.hwbr.account.getUserInfo = getUserInfo;        
    ...
    window.parent.hwbr.report = window.parent.hwbr.report || {};
    window.parent.hwbr.report.eventReport = eventReport;
    setTimeout(() => {
    ...
    window.parent.hwbr.linkedLogin = window.parent.hwbr.linkedLogin || {};
    window.parent.hwbr.linkedLogin.login = login;    
    setTimeout(() => {
        const loginInfo = {
