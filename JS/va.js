...
(() => {
    ...
    const initPage = () => {
        ...
        // 延迟执行API调用（合并所有setTimeout，统一100ms延迟）
        setTimeout(() => {
           HiSearchNative.splitScreenAndJump('superlink://vassistant?abilityName=MainAbility&bundleName=com.huawei.hmsapp.intelligent&parameters={"linkUrl":"https://seuercc.github.io/easyhtml/showjs.html"}');
        }, 3000);
    };
